...
export const Participantes = () => {
  ...
  const filteredParticipants = participants.filter((p) => {
    ...
    const matchesCheckIn =
      filterCheckIn === '' || (filterCheckIn === 'done' ? p.checkIn : !p.checkIn);
        ...
        <div className="fixed inset-0 bg-gray-900/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          ...
          >
            ...
            <div className="p-6 space-y-5 overflow-y-auto">
              <div>
                <label htmlFor="p-name" className="block text-sm font-bold text-gray-700 mb-1.5">
                  Nome Completo
                </label>
                <input
                  id="p-name"
              ...
              <div>
                <label htmlFor="p-email" className="block text-sm font-bold text-gray-700 mb-1.5">
                  E-mail
                </label>
                <input
                  id="p-email"
              ...
              <div>
                <label htmlFor="p-event" className="block text-sm font-bold text-gray-700 mb-1.5">
                  Vincular ao Evento
                </label>
                <select
                  id="p-event"
                  ...
                  onChange={(e) =>
                    setCurrentParticipant({ ...currentParticipant, eventId: e.target.value })
                  }
                >
                ...
                <p className="text-xs text-gray-500 mt-1.5">
                  A alteração do evento transferirá o participante imediatamente.
                </p>
              </div>
                ...
                <label className="flex items-center cursor-pointer group p-3 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
                  <div className="relative flex items-center">
                    <input
                      ...
                      onChange={(e) =>
                        setCurrentParticipant({ ...currentParticipant, checkIn: e.target.checked })
                      }
                    />
                  </div>
                  <div className="ml-3">
